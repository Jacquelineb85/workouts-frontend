...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n          \n        <sl-avatar shape=\"square\"; style=\"--size: 200px; margin-bottom: 1em;\" image=", "></sl-avatar>\n        "]);
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n\n    <style>\n  \n   @media (min-width: 601px){ \n    .photo{\n      margin-top: 200px;\n      display: inline-block;\n      background-color: yellow;\n      width: 600px;\n      padding: 40px;\n      margin-left: 120px;\n    }\n  }\n    \n    @media (max-width: 600px){\n      .photo{\n      display: inline-block;\n      background-color: yellow;\n      width: 300px;\n      padding: 40px;\n      margin-top: 200px;\n      margin-left: 20px;\n    }\n  }\n\n    .text{\n      float: right;\n      max-width: 300px;\n\n      \n    \n\n    </style>\n      <va-app-header title=\"Radical Fitness\" user=", "></va-app-header>\n     \n      <div class\"page-content\" \"page-centered\">\n       \n       <div class=\"photo\">               \n        ", "\n    \n       <div class=\"text\">\n        <h2>", " ", "</h2>\n        <h3>", "</h3>\n       \n        <p>", "</p>\n\n        ", "\n      \n       \n        \n        <sl-button class=\"anim-in\" @click=", ">Edit Profile</sl-button>\n       </div>\n        \n\n          </div>        \n         \n    "]);
...
class UserAPI {
  ...
  async addFavWorkout(workoutId) {
    // validate
    if (!workoutId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavWorkout"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding workout to favourites');
    } // convert response payload into json - store as data
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a'), this.updateProfileSubmitHandler.bind(this), this.user.firstName, this.user.lastName, this.user.email, this.user.location, this.user.bio, this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5())));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"WorkoutAPI.js":[function(require,module,exports) {
"use strict";
...
class WorkoutAPI {
  ...
  async newWorkout(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/workout"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
...
var _default = new WorkoutAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/workouts.js":[function(require,module,exports) {
"use strict";
...
var _WorkoutAPI = _interopRequireDefault(require("./../../WorkoutAPI"));
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n      .filter-menu {\n         display: flex;\n         align-items: center;\n      }\n\n      .filter-menu > div {\n        margin-right: 1em;\n      }\n\n      .buttons{\n        background-color: yellow;\n        padding: 10px;\n      }\n\n      .clear{\n        background-color: black;\n        padding: 1px;\n        margin-left: 200px;\n      }\n      </style>\n\n      <va-app-header title=\"Radical Fitness\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">       \n      <div class=\"buttons\">\n      <div class=\"filter-menu\">\n      <div> \n      Filer by\n      </div>\n      <div>\n      <strong>Workout type:</strong>      \n    \n      <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"weight loss\" @click=", ">Weight loss</sl-button>\n      <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"strength training\" @click=", ">Strength training</sl-button>\n      <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"flexability\" @click=", ">Flexability</sl-button>\n      <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"relaxation\" @click=", ">Relaxation</sl-button>\n      <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"rehabilitation\" @click=", ">Rehabilitation</sl-button>\n      <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"post-natal\" @click=", ">Post-natal</sl-button>\n      <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"sports performance\" @click=", ">Sports performance</sl-button>\n      \n      </div>\n      <div class=\"clear\">\n      <sl-button size=\"small\" @click=", ">Clear Filters</sl-button>\n      </div>\n\n      </div>\n       </div> \n      <div class=\"workout-grid\">\n      ", " \n      </div>      \n      </div>\n      "]);
...
class WorkoutsView {
  ...
  async filterWorkouts(field, match) {
    //validate
    if (!field || !match) return; // get fresh copy of workouts

    this.workouts = await _WorkoutAPI.default.getWorkouts();
    let filteredWorkouts; //location 
  ...
  handleFilterBtn(e) {
    ...
    this.clearFilterBtns(); // clear all filter buttons active (type = primary)

    e.target.setAttribute("type", "primary"); // extract the field and match from the button

    const field = e.target.getAttribute("data-field");
    const match = e.target.getAttribute("data-match"); // filter workouts
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.workouts == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.workouts.map(workout => (0, _litHtml.html)(_templateObject4(), workout._id, workout.name, workout.image, workout.description, workout.location, JSON.stringify(workout.user), workout.type))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new WorkoutsView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../WorkoutAPI":"WorkoutAPI.js","../../Toast":"Toast.js"}],"views/pages/trainers.js":[function(require,module,exports) {
"use strict";
...
var _default = new TrainersView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/favouriteWorkouts.js":[function(require,module,exports) {
"use strict";
...
class FavouriteWorkoutsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.favWorkouts == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.favWorkouts.map(workout => (0, _litHtml.html)(_templateObject4(), workout._id, workout.name, workout.image, workout.description, workout.location, JSON.stringify(workout.user), workout.type))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new FavouriteWorkoutsView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../UserAPI":"UserAPI.js"}],"views/pages/newWorkout.js":[function(require,module,exports) {
"use strict";
...
class newWorkoutView {
  ...
  async newWorkoutSubmitHandler(e) {
    ...
    try {
      await _WorkoutAPI.default.newWorkout(formData);

      _Toast.default.show('Workout added!');

      submitBtn.removeAttribute('loading'); // reset form
      // reset text textarea inputs

      const textInputs = document.querySelectorAll('sl-input, sl-textarea');
      if (textInputs) textInputs.forEach(textInput => textInput.value = null); // reset menus

      const menuInputs = document.querySelectorAll('sl-menu-item');
      if (menuInputs) menuInputs.forEach(menuInput => menuInput.value = null); // reset file input
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.newWorkoutSubmitHandler, _Auth.default.currentUser._id);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new newWorkoutView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../WorkoutAPI":"WorkoutAPI.js","../../Toast":"Toast.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _workouts = _interopRequireDefault(require("./views/pages/workouts"));

var _trainers = _interopRequireDefault(require("./views/pages/trainers"));

var _favouriteWorkouts = _interopRequireDefault(require("./views/pages/favouriteWorkouts"));

var _newWorkout = _interopRequireDefault(require("./views/pages/newWorkout"));
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/workouts":"views/pages/workouts.js","./views/pages/trainers":"views/pages/trainers.js","./views/pages/favouriteWorkouts":"views/pages/favouriteWorkouts.js","./views/pages/newWorkout":"views/pages/newWorkout.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n        <a href=\"/newWorkout\" @click=\"", "\">Add Workout</a>\n        "]);
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title) : "", _Router.anchorRoute, this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject3(), _Router.anchorRoute) : '', e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', this.user && this.user.firstName, () => (0, _Router.gotoRoute)('/'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject4(), this.menuClick) : '', () => _Auth.default.signOut());
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"components/va-workout.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-workout', class Workout extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  moreInfoHandler() {
    ...
    dialogEl.className = 'workout-dialog'; // sl-dialog content

    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.name, this.name, this.description, this.location, this.type, this.addFavHandler.bind(this));
  ...
  async addFavHandler() {
    try {
      _UserAPI.default.addFavWorkout(this.id);

      _Toast.default.show('Workout added to favourites');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-workout":"components/va-workout.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
