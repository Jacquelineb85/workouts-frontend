  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <nav class="app-top-nav">
        ...
        <a href="/newWorkout" @click="${anchorRoute}">Add Workout</a>
        ...
        <sl-dropdown>
          ...
          <sl-menu>            
            <sl-menu-item @click="${() => gotoRoute('/')}">Profile</sl-menu-item>
    ...
    <sl-drawer class="app-side-menu" placement="left">
      ...
      <nav class="app-side-menu-items">
        ...
        ${this.user.accessLevel ==2 ? html`
        <a href="/newWorkout" @click="${this.menuClick}">Add Workout</a>
        ` : ''}
