      ...
      <div class="page-content">        
        ...
        `:html`
          ...
          <sl-form class="page-form" @sl-submit=${this.updateProfileSubmitHandler.bind(this)}>
            ...
            <div class="input-group">
              <sl-input type="text" name="location" value="${this.user.location}" placeholder="Location"></sl-input>
            </div>            
                        
            <div class="input-group">
            <sl-textarea name="bio" rows="4" placeholder="tell us your fitness goals or about your business" value="${this.user.bio}"></sl-textarea>
          </div>
            <div class="input-group">
